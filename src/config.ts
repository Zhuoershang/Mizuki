...
export const siteConfig: SiteConfig = {
	...
	bilibili: {
		vmid: "359800025", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			subtitle: [
				...
				"你啊，不知不觉中就成了我的每一天",
				"和你聊天，总觉得每天都会变得开心一点",
				"今天是个平凡的日子。不过，是稍微好一点的日子",
				"你是我心中的烈焰，却没有烈焰那般坚定地爱恋",
			],
			typewriter: {
...
export const profileConfig: ProfileConfig = {
	avatar: "https://zers.xian5.de5.net/images/asset/themes/fuwari/avatar.png?v=1773756359", //      assets/images/avatar.webp 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "卓尔伤",
	bio: "世界那么大，你来看看我",
	typewriter: {
	...
	links: [
		{
			name: "Bilibili",
			icon: "fa7-brands:bilibili",
			url: "https://space.bilibili.com/359800025",
		},
		{
			name: "Gitee",
			icon: "mdi:git",
			url: "https://gitee.com/zers",
		},
		{
			name: "GitHub",
			icon: "fa7-brands:github",
			url: "https://github.com/Zhuoershang",
		},
		{
			name: "Codeberg",
			icon: "simple-icons:codeberg",
			url: "https://mblog.xian5.de5.net",
		},
		{
			name: "Discord",
